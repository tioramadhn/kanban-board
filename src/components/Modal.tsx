export default function Modal({ children = "modal", handleOpen }: any) {
  return (
    <div className="fixed top-0 left-0 h-screen w-screen z-[99999] ">
      ...
      ></div>
      <div className="p-6 rounded-[10px] shadow-modal bg-white min-w-[320px] md:w-[420px]  modal-box absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%] z-[1]">
        {children}
      </div>
    </div>
  );
